...
export default function KontaktPage() {
  return (
    <>
      <Head>
        <title>
          KONTAKT | Silke May | Kunsttherapeutin DGKT | Heilpraktikerin für
          Psychotherapie
        </title>
        <meta
          name="description"
          content="Kontakseite von Silke May - Kunsttherapeutin DGKT, Heilpraktikerin für Psychotherapie, bildende Künstlerin aus Bonn"
        />
