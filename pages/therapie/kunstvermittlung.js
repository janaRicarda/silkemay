...
export default function KunstvermittlungPage() {
  return (
    <>
      <Head>
        <title>
          KUNSTVERMITTLUNG - SILKE MAY - KUNSTTHERAPEUTIN DGKT / HEILPRAKTIKERIN
          FÜR PSYCHOTHERAPIE
        </title>
        <meta
          name="description"
      ...
      <PageContent
        content={artMediation}
        src={Kunstvermittlung}
        alt={"Menschen sitzen auf Stühlen in einem Halbkreis"}
      />
    </>
  );
}
